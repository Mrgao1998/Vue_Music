...
const thisdata = {'req': {'module': 'CDN.SrfCdnDispatchServer', 'method': 'GetCdnDispatch', 'param': {'guid': '5628357928', 'calltype': 0, 'userip': ''}}, 'req_0': {'module': 'vkey.GetVkeyServer', 'method': 'CgiGetVkey', 'param': {'guid': '5628357928', 'songmid': [`${songmid}`], 'songtype': [0], 'uin': '1094210277', 'loginflag': 1, 'platform': '20'}}, 'comm': {'uin': 1094210277, 'format': 'json', 'ct': 24, 'cv': 0}}
...
function getSign(data) {
  ...
  const returndata = Object.assign({}, {
    // '-': 'getplaysongvkey2668086662296678',
    g_tk: 484909013,
    sign: getSign(thisdata),
    loginUin: 1094210277,
    hostUin: 0,
    format: 'json',
    inCharset: 'utf8',
  ...
  return axios.get(url, {
    ...
    // console.log(`http://113.106.207.149/amobile.music.tc.qq.com/${res.data.req_0.data.midurlinfo[0].purl}`)
